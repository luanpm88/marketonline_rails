...
class SystemMessagesControllerTest < ActionController::TestCase
  ...
  test "should create system_message" do
    assert_difference('SystemMessage.count') do
      post :create, system_message: { code: @system_message.code, content: @system_message.content, name: @system_message.name }
    end
  ...
  test "should update system_message" do
    patch :update, id: @system_message, system_message: { code: @system_message.code, content: @system_message.content, name: @system_message.name }
    assert_redirected_to system_message_path(assigns(:system_message))
  end
