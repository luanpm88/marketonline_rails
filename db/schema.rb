...
ActiveRecord::Schema.define(version: 20160125074037) do
  ...
  create_table "agent_payments", force: :cascade do |t|
    ...
    t.datetime "created_at",                                                     null: false
    t.datetime "updated_at",                                                     null: false
    t.string   "payment_type", limit: 255,                  default: "discount"
  ...
  create_table "pb_members", force: :cascade do |t|
    ...
    t.integer  "total_sold_products",       limit: 4
    t.decimal  "total_bought",                            precision: 10
    t.decimal  "total_sellers",                           precision: 10
    t.decimal  "real_total_bought",                       precision: 10
    t.integer  "total_bought_products",     limit: 4
  end
