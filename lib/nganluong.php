...
class NL_Checkout 
{
	...
	private $merchant_site_code = '39955'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn

	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	private $secure_pass= 'marketonlinebmn@#$'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
...
// Command line access
if($argv[1] == "get_checkout_url") {
	$checkout = new NL_Checkout;
	$url = $checkout->buildCheckoutUrl($argv[2],$argv[3],$argv[4],$argv[5],$argv[6]);
	echo trim($url);
}
?>